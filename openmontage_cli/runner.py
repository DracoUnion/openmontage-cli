...
from openmontage_cli import config, bridge
from openmontage_cli.gates import GatePolicy
...
def make(
    ...
    *,
    ...
    if om_root:
        ...
        from openmontage_cli.utils.paths import project_root as _pr
    ...
    from openmontage_cli.llm.providers.openai import OpenAIOrchestrator
    from openmontage_cli.llm.orchestrator import Orchestrator
